...
function LogoMark() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0 w-[34px] h-[70px]">
      ...
      <div
        className="col-1 row-1 relative"
        style={{ width: 16, height: 57, marginLeft: 9, marginTop: 14 }}
      >
        <svg
          className="block size-full"
          fill="none"
          preserveAspectRatio="none"
          viewBox="0 0 16.7799 57.1872"
        >
          ...
          <path
            d={svgPaths.p36996180}
            fill="black"
            stroke="black"
            strokeWidth="1.88976"
          />
          <path
            d={svgPaths.p2c2b7800}
            fill="black"
            stroke="black"
            strokeWidth="1.88976"
          />
