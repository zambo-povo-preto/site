  ...
  return (
    <div className="min-h-screen w-full flex" style={{ background: "#f5eedd" }}>
      ...
      <div
        ...
        style={{ background: "#fff", borderRight: "3px solid #121212" }}
      >
        {/* Background texture */}
        <div
        ...
        <div className="relative flex flex-col gap-6">
          ...
          >
            Gerencie os documentos públicos do Ponto de Cultura Zambô e mantenha
            o portal da transparência atualizado.
          </p>
        </div>
        ...
        >
          ...
          <br />
          Em caso de problemas, contate: ti@zambo.org.br
        </p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-[420px] flex flex-col gap-8">
          ...
          <div
            className="flex flex-col gap-7 p-8 rounded-[4px]"
            style={{
              background: "#fff",
          ...
          >
            <div className="flex flex-col gap-1">
              ...
              >
                Acesse o painel de gestão de documentos
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              {error && (
                <div
                  ...
                  style={{
                    background: "rgba(221,52,31,0.06)",
                    border: "1px solid rgba(221,52,31,0.3)",
                  }}
                >
                  <svg
                    width="16"
                    ...
                    strokeLinecap="round"
                    role="img"
                    aria-label="Erro de autenticação"
                  >
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow: loading ? "none" : "4px 4px 0px #121212",
            ...
            {/* <div
              ...
              style={{
                ...
                border: "1px solid rgba(248,186,1,0.4)",
              }}
            >
              <p
                style={{
